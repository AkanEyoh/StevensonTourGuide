...
## Description: Loads the data for adjacency lists and room lists into in each location type.

## Format:
## Hallways are split down the middle and separated by an elevator, however hallways on the same floor still act as
#  adjacent nodes to each other.

## Naming Convention:
## staircaseX_Y: X = floor number, Y = end of hallway (1 = bottom half, 2 = top half)
## hallwayX_Y: X = floor number, Y = end of hallway (1 = bottom half, 2 = top half)
## elevatorX: X = which floor an elevator stops at

## Determining length of hallway was relative to how many classrooms were in 1 hallway.

import locations

## Floor 1 Locations
staircase1_1 = Staircase()
...
elevator1 = Elevator()
elevator1.adjList = [hallway1_1, hallway1_2, elevator2, elevator3, elevator4, elevator5]

hallway1_2 = Hallway()
hallway1_2.roomList = ["1103", "1107", "1109", "1110", "1110A", "1110B", "1110C", "1130"]
hallway1_2.adjList = [staircase1_2, elevator1, hallway1_1]
hallway1_2.length = 8

staircase1_2 = Staircase()
staircase1_2.adjList = [hallway1_2, staircase2_2]

## Floor 2 Locations
staircase2_1 = Staircase()
staircase2_1.adjList = [hallway2_1, staircase1_1, staircase3_1]

hallway2_1 = Hallway()
hallway2_1.roomList = ["1210", "1214", "1216", "1220", "1221", "1222", "1224", "1227", "1232"]
...
staircase2_2 = Staircase()
staircase2_2.adjList = [hallway2_2, staircase1_2]

# Floor 3 Locations
staircase3_1 = Staircase()
